    ...
    axios
      ...
      deleteItem (item) {
       ...
       const data = new URLSearchParams();
        ...
        axios.post('http://localhost:50625/api/values/deletepurchase', data, {headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': 'Bearer '+ sessionStorage.getItem('accessToken') },
           }
